...
```
The polyfits seem to be more accurate than their respective linear models, but since the polyfits can't consider both ARM and GRIP at the same time as SIMS, model 3 is likely more accurate.  
# Model results 
